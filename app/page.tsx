      ...
      <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container flex h-16 items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-lg font-semibold dark:neon-text">SnippetHub</span>
          </div>
          <div className="flex items-center gap-4">
            <ThemeToggle />
            <Link href="/login">
              <Button variant="ghost" className = "rounded dark:neon-text">Iniciar Sesión</Button>
            </Link>
            <Link href="/register">
              <Button className = "rounded">Registrarse</Button>
            </Link>
          </div>
        </div>
      </header>
        ...
        <section className="py-20 md:py-28">
          <div className="container flex flex-col items-center text-center">
            ...
            <div className="mt-8 flex flex-col gap-4 sm:flex-row">
              ...
              <Link href="/login">
                <Button size="lg" variant="outline" className="gap-2 rounded dark:neon-pulse dark:neon-text">
                  Iniciar Sesión
                </Button>
              </Link>
            </div>
        ...
        <section className="border-t bg-muted/40 py-16">
          <div className="container">
            ...
            <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
              <div className="flex flex-col items-center rounded border bg-card p-6 text-center shadow-sm ">
              ...
              <div className="flex flex-col items-center rounded border bg-card p-6 text-center shadow-sm">
                ...
                <h3 className="mb-2 text-xl font-mediumn dark:neon-text">Resaltado de Sintaxis</h3>
                <p className="text-muted-foreground">
