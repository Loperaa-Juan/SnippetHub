    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
        ...
        <section className="border-t bg-muted/40 py-16">
          <div className="container">
            <h2 className="mb-10 text-center text-3xl font-bold">¿Por qué elegir SnippetHub?</h2>
            <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
              <div className="flex flex-col items-center rounded-lg border bg-card p-6 text-center shadow-sm">
                ...
                <h3 className="mb-2 text-xl font-medium">Ahorra Tiempo</h3>
              ...
              <div className="flex flex-col items-center rounded-lg border bg-card p-6 text-center shadow-sm">
                ...
                <h3 className="mb-2 text-xl font-medium">Organización Eficiente</h3>
                <p className="text-muted-foreground">
              ...
              <div className="flex flex-col items-center rounded-lg border bg-card p-6 text-center shadow-sm">
                ...
                <h3 className="mb-2 text-xl font-medium">Búsqueda Potente</h3>
                <p className="text-muted-foreground">
              ...
              <div className="flex flex-col items-center rounded-lg border bg-card p-6 text-center shadow-sm">
                ...
                <h3 className="mb-2 text-xl font-medium">Etiquetado Inteligente</h3>
                <p className="text-muted-foreground">
              ...
              <div className="flex flex-col items-center rounded-lg border bg-card p-6 text-center shadow-sm">
                ...
                <h3 className="mb-2 text-xl font-medium">Resaltado de Sintaxis</h3>
                <p className="text-muted-foreground">
              ...
              <div className="flex flex-col items-center rounded-lg border bg-card p-6 text-center shadow-sm">
                ...
                <h3 className="mb-2 text-xl font-medium">Experiencia Personalizada</h3>
                <p className="text-muted-foreground">
      ...
      <footer className="border-t py-6">
        <div className="container flex flex-col items-center justify-between gap-4 md:flex-row">
          ...
          <p className="text-center text-sm text-muted-foreground">© 2024 SnippetHub. Todos los derechos reservados.</p>
